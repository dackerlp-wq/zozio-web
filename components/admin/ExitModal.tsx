    ...
    try {
      await fetch(`/api/animals/${animalId}`, {
        ...
        body: JSON.stringify({
          ...
          adoption_contract_number: form.contractNumber,
          return_owner_name: form.ownerName,
          return_owner_doc: form.ownerDocId,
          transfer_institution: form.targetInstitution,
          death_type: form.deathType,
          death_vet: form.vet,
          death_cause: form.cause,
          disposal_method: form.disposalMethod,
          disposal_doc: form.disposalDoc,
          disposal_firm: form.disposalFirm,
        }),
      })
      onClose()
    } catch {
