  ...
  return (
    <div className="animate-pulse space-y-5">
      <div className="flex gap-3">
        <div className="h-10 flex-1 bg-[#F0EDE8] rounded-xl" />
        <div className="h-10 w-32 bg-[#F0EDE8] rounded-xl" />
      </div>
      <div className="flex gap-2">
        {[...Array(4)].map((_, i) => <div key={i} className="h-8 w-24 bg-[#F0EDE8] rounded-full" />)}
      </div>
