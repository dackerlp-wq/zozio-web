...
export default async function MapPage() {
  ...
  const rescue   = institutions.filter(i => i.type === 'rescue_station').length
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        <div className="py-6 md:py-8">
          <h1 className="font-display font-extrabold text-[#1A0F0A] mb-1"
            ...
            🗺️ Mapa útulků a záchranných stanic
          </h1>
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            {[
              { label: 'Celkem institucí', value: total, color: '#1A0F0A' },
              { label: 'Útulky',           value: shelters, color: '#E8634A' },
              { label: 'Záchranné stanice', value: rescue,  color: '#2E9E8F' },
        ...
        <div className="flex flex-wrap items-center gap-4 mt-4 text-xs" style={{ color: '#8B6550' }}>
          ...
          <div className="flex items-center gap-1.5">
            <span className="w-4 h-4 rounded-full bg-[#2E9E8F] inline-block" />
            Záchranná stanice
          </div>
