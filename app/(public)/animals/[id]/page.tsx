...
function AnimalInfoBox({ a, age, sexLabel, sizeLabel, species }: any) {
  ...
  const rows: { icon: string; label: string; value: string }[] = [
    ...
    a.origin                          && { icon: '📍', label: 'Původ',           value: ORIGIN_LABEL[a.origin as string] ?? a.origin },
    intakeDate                        && { icon: '📅', label: 'V útulku od',    value: intakeDate },
    a.intake_reason                   && { icon: '💬', label: 'Důvod příchodu', value: INTAKE_REASON_LABEL[a.intake_reason as string] ?? a.intake_reason },
